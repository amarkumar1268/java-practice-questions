...
public class ReenterantLock implements Runnable {
	...
	public ReenterantLock(ReentrantLock rl, String n) {
		re = rl;
		name = n;
	}
	...
	public static void main(String[] args) {
		...
		Runnable w1 = new ReenterantLock(rel, "Job1");
		Runnable w2 = new ReenterantLock(rel, "Job2");
		Runnable w3 = new ReenterantLock(rel, "Job3");
		Runnable w4 = new ReenterantLock(rel, "Job4");
		pool.execute(w1);
		pool.execute(w2);
		pool.execute(w3);
		pool.execute(w4);
